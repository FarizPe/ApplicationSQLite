package com.fariz.applicationsqlite;
...
public class AdaptereDaftarCatatan extends BaseAdapter {
    ...
    public AdaptereDaftarCatatan(List<SetterGetterData> sgd, Context context, AlertDialog daftarCatatan) {
        this.sgd = sgd;
